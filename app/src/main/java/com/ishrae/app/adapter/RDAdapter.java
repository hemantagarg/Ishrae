...
public class RDAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    private Context mContext;
    public ArrayList<RD> list;
    ...
    public RDAdapter(Context mContext, ArrayList<RD> list, RecyclerView recyclerView, OnLoadMoreListener onLoadMoreListener1) {
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder1, final int position) {
        ...
        if (holder1 instanceof ViewHolder) {
            ...
            RD regionalDirector = list.get(position);
            holder.txtBOGName.setText("" + regionalDirector.Name);
            holder.txtBOGCompany.setText("" + regionalDirector.CompanyName);
            holder.txtBOGDesignation.setText("" + regionalDirector.Designation);
            holder.txtBOGEmail.setText("" + regionalDirector.Email);

            Glide.with(mContext)
                    .load(regionalDirector.MemberPhoto)
