...
public class PendingPostEventAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
...
private View.OnClickListener onClickListener;
    ...
    public PendingPostEventAdapter(Context mContext, ArrayList<PendingPostEventListModel> list, RecyclerView recyclerView, OnLoadMoreListener onLoadMoreListener1, View.OnClickListener onClickListener) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        if (viewType == VIEW_PROG) {
            ...
            View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.ciq_events_row, parent, false);
